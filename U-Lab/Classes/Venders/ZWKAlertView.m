...
- (void)setup
{
    ...
    self.blackControl.backgroundColor = [UIColor blackColor];
    ...
    cancelButton.backgroundColor = kCommonWhiteColor;
    [cancelButton setTitle:@"取消" forState:UIControlStateNormal];
    [cancelButton setTitleColor:kTextBlackColor forState:UIControlStateNormal];

...
@interface ULLabObjectView() <UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource,ULSegmentViewDelegate>
...
@implementation ULLabObjectView
{
...
- (UITableView *)oneTableView
{
    if (!_oneTableView)
    {
        ...
        [_oneTableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"ULLabObjectOneTableViewCellIdentifier"];
        ...
        _oneTableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
            ...
            [_oneArray removeAllObjects];
            _onePage = 1;
            [self.viewModel.objectCommand execute:@{@"type" : @1, @"page": @(_onePage), @"size":@10, @"labId" : @([ULUserMgr sharedMgr].laboratoryId)}];
        }];
...
- (UITableView *)twoTableView
{
    if (!_twoTableView)
    {
        ...
        [_twoTableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"ULLabObjectTwoTableViewCellIdentifier"];
...
- (UITableView *)fourTableView
{
    if (!_fourTableView)
    {
        ...
        [_fourTableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"ULLabObjectFourTableViewCellIdentifier"];
...
- (UITableView *)threeTableView
{
    if (!_threeTableView)
    {
        ...
        [_threeTableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"ULLabObjectThreeTableViewCellIdentifier"];
...
- (UITableView *)fiveTableView
{
    if (!_fiveTableView)
    {
        ...
        [_fiveTableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"ULLabObjectFiveTableViewCellIdentifier"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.oneTableView)
    {
        cell = [self.oneTableView dequeueReusableCellWithIdentifier:@"ULLabObjectOneTableViewCellIdentifier"];
        model = _oneArray[indexPath.row];
    } else if (tableView == self.twoTableView) {
        model = _twoArray[indexPath.row];
        cell = [self.twoTableView dequeueReusableCellWithIdentifier:@"ULLabObjectTwoTableViewCellIdentifier"];
    } else if (tableView == self.threeTableView) {
        model = _threeArray[indexPath.row];
        cell = [self.threeTableView dequeueReusableCellWithIdentifier:@"ULLabObjectThreeTableViewCellIdentifier"];
    } else if (tableView == self.fourTableView) {
        model = _fourArray[indexPath.row];
        cell = [self.fourTableView dequeueReusableCellWithIdentifier:@"ULLabObjectFourTableViewCellIdentifier"];
    } else {
        model = _fiveArray[indexPath.row];
        cell = [self.fiveTableView dequeueReusableCellWithIdentifier:@"ULLabObjectFiveTableViewCellIdentifier"];
    }
    ...
    NSString *numString = [NSString stringWithFormat:@"数量：%lu%@", model.objectQuantity, model.measureUnit];
